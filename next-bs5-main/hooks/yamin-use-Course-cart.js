...
const YaminCourseCartContext = createContext(null)

// 2. 建立CartProvider元件
// 夾在中間裡的 就叫做props.childrens
// 例如這樣<MyCom>中間就是props.childrens</MyCom>
export const YaminCourseCartProvider = ({
  children,
  initialCartItems = [],
  ...
  return (
    <YaminCourseCartContext.Provider
      value={{
        cart: cartState,
...
export const YaminCourseUseCart = () => useContext(YaminCourseCartContext)
